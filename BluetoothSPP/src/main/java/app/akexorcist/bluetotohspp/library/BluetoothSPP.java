...
public class BluetoothSPP {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case BluetoothState.MESSAGE_DEVICE_NAME:
                    Log.d("read","MESSAGE_DEVICE_NAME");
                    ...
                    if(mBluetoothConnectionListener != null) {
                        ...
                        Log.i("MHS", "Calling connected method: " + mBluetoothConnectionListener.toString());
                    }
                    isConnected = true;
                    break;
    ...
    public boolean send(byte[] data, boolean CRLF) {
        if(mChatService != null && mChatService.getState() == BluetoothState.STATE_CONNECTED) {
            if(CRLF) {
